  ...
  if (mobile) {
    return (
      <div className={classes.mobileWrapper}>
        <IconBtn icon={GitHub} m={1} href="https://github.com/usaid-anxari/" />
        <IconBtn
          icon={Instagram}
          m={1}
          href="https://www.instagram.com/usaid.anxari/"
        />
        <IconBtn
          icon={LinkedIn}
          m={1}
          href="https://www.linkedin.com/in/usaid-ahmed-ansari-861547246/"
        />
        <IconBtn icon={Email} m={1} href="mailto:ausaid109@gmail.com" />
      </div>
    );
  } else {
    return (
      <motion.div className={classes.wrapper}>
        <motion.div animate={controls} custom={0}>
          <IconBtn
            icon={GitHub}
            m={1}
            href="https://github.com/usaid-anxari/"
          />
        </motion.div>
        ...
        <motion.div animate={controls} custom={3}>
          <IconBtn
            icon={Email}
            m={1}
            href="mailto:ausaid109@gmail.com"
          />
        </motion.div>
