...
const MessageBox = () => {
    ...
    const SendEmail = (object) => {
        setSending(true);
        emailjs.send("service_rpth8bw", "template_vwyezh1", object, "sjfyzQxIyD2hoPK5D").then(
            (result) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            phone: Yup.string().min(9,'Must be Minimum 9 digits').max(15, 'Must be Maximum 15 digits'),
